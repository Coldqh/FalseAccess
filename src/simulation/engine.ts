...
function createSkills(): Record<SimulationSkillId, SkillTrackState> {
  return {
    ...
    detectionEngineering: blankSkill(),
    threatIntelligence: blankSkill(),
    cryptography: blankSkill(),
    malwareAnalysis: blankSkill(),
    securityEngineering: blankSkill(),
    appsec: blankSkill(),
    mobileSecurity: blankSkill(),
    cloud: blankSkill(),
    containerSecurity: blankSkill(),
    devsecops: blankSkill(),
    vulnerabilityManagement: blankSkill(),
    architecture: blankSkill(),
    governanceRisk: blankSkill(),
    businessContinuity: blankSkill(),
