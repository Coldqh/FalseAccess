    ...
    const base: MailItem[] = [
      {
        ...
        preview: 'Архив с регистратуры готов. Оригиналы остались у нас...',
        body: [
          'Илья,',
          'Архив с регистратуры готов. Оригиналы остались у нас, данные пациентов удалены.',
          ...
          'Открой Missions. Я буду на связи.',
          '— Максим',
        ],
        time: '21:18', unread: !progress.readMail.includes('maxim-case'), attachment: 'clinic-01.evidence',
      },
      {
        id: 'mentor-call', sender: 'Максим Белов', address: 'm.belov@ostroclinic.local', subject: 'Созвон по CLINIC-01',
        preview: 'Начнём с терминала. Ничего не удаляй...',
        body: [
          'Илья,',
          'Начнём с терминала. Ничего не удаляй.',
          'Сначала найди папку дела и прочитай brief.txt. Я буду на связи.',
          'Открой Missions и ответь на вызов.',
          '— Максим',
        ],
