    ...
    const base: MailItem[] = [
      {
        ...
        body: [
          ...
          'Не знаешь термин — сначала открой Academy. Потом начни с домашней папки /home/ilya. Команда help покажет доступные инструменты.',
          '— Максим',
        ],
        time: '21:18', unread: !progress.readMail.includes('maxim-case'), attachment: 'clinic-01.evidence',
      },
      {
        id: 'course-linux', sender: 'Academy Zero', address: 'academy@training.local', subject: 'Начни с семи базовых понятий',
        preview: 'Компьютер, операционная система, файлы, пути, терминал...',
        body: [
          'Перед первым делом пройди Academy Zero.',
          'Она объясняет: что такое операционная система, файл, папка, путь, команда, IP, порт, лог, программа, переменная, цикл и технический факт.',
          'После каждого объяснения есть один короткий вопрос. Ошибки ничего не ломают.',
        ],
        time: '19:40', unread: !progress.readMail.includes('course-linux'),
      },
    ];
