...
export const createInitialProgress = () => ({
  ...
  foundationModulesComplete: [] as string[],
  foundationTaskIds: [] as string[],
  foundationAnswers: {} as Record<string, string>,
  foundationExamDrafts: {} as Record<string, string>,
  ...
  huntCaseStage: 0,
  huntCaseFoundationAnswers: {} as Record<string, string>,
  huntCaseHypothesisAnswers: {} as Record<string, string>,
  huntCaseObjectives: [] as string[],
  huntCaseSigma: '',
  huntCaseKql: '',
  huntCaseTuningSelections: {} as Record<string, string>,
  huntCaseIndependentObjectives: [] as string[],
  huntCaseIndependentAnswers: {} as Record<string, string>,
  huntCaseReportSelections: {} as Record<string, string>,
  huntCaseHintUses: 0,
  huntCaseComplete: false,
  cryptoCaseStage: 0,
  cryptoCaseFoundationAnswers: {} as Record<string, string>,
  cryptoCasePkiObjectives: [] as string[],
  cryptoCasePkiAnswers: {} as Record<string, string>,
  cryptoCaseStaticObjectives: [] as string[],
  cryptoCaseStaticAnswers: {} as Record<string, string>,
  cryptoCaseYara: '',
  cryptoCaseYaraAnswers: {} as Record<string, string>,
  cryptoCaseIndependentObjectives: [] as string[],
  cryptoCaseIndependentAnswers: {} as Record<string, string>,
  cryptoCaseReportSelections: {} as Record<string, string>,
  cryptoCaseHintUses: 0,
  cryptoCaseComplete: false,
  cloudCaseStage: 0,
  cloudCaseFoundationAnswers: {} as Record<string, string>,
  cloudCaseObjectives: [] as string[],
  cloudCasePatch: '',
  cloudCaseIndependentObjectives: [] as string[],
  cloudCaseIndependentAnswers: {} as Record<string, string>,
  cloudCaseReportSelections: {} as Record<string, string>,
  cloudCaseHintUses: 0,
  cloudCaseComplete: false,
  supplyCaseStage: 0,
  supplyCaseFoundationAnswers: {} as Record<string, string>,
  supplyCaseObjectives: [] as string[],
  supplyCasePatch: '',
  supplyCaseIndependentObjectives: [] as string[],
  supplyCaseIndependentAnswers: {} as Record<string, string>,
  supplyCaseReportSelections: {} as Record<string, string>,
  supplyCaseHintUses: 0,
  supplyCaseComplete: false,
  architectureCaseStage: 0,
  architectureCaseFoundationAnswers: {} as Record<string, string>,
  architectureCaseObjectives: [] as string[],
  architectureCasePatch: '',
  architectureCaseIndependentObjectives: [] as string[],
  architectureCaseIndependentAnswers: {} as Record<string, string>,
  architectureCaseReportSelections: {} as Record<string, string>,
  architectureCaseHintUses: 0,
  architectureCaseComplete: false,
  capstoneCaseStage: 0,
  capstoneCaseFoundationAnswers: {} as Record<string, string>,
  capstoneCaseObjectives: [] as string[],
  capstoneCasePatch: '',
  capstoneCaseIndependentObjectives: [] as string[],
  capstoneCaseIndependentAnswers: {} as Record<string, string>,
  capstoneCaseReportSelections: {} as Record<string, string>,
  capstoneCaseHintUses: 0,
  capstoneCaseScore: 0,
  capstoneCaseComplete: false,
  readMail: [] as string[],
